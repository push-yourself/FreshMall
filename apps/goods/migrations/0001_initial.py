    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sales', models.IntegerField(choices=[(0, '下线'), (1, '上线')], default=1, verbose_name='商品销量')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_delete', models.BooleanField(default=False, verbose_name='删除标记')),
                ('index', models.SmallIntegerField(default=0, verbose_name='展示顺序')),
                ('display_type', models.SmallIntegerField(choices=[(0, '标题'), (1, '图片')], default=1, verbose_name='展示内容')),
