# Generated by Django 2.2.12 on 2020-07-01 08:23
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('transit_status', models.DecimalField(decimal_places=2, max_digits=10, verbose_name='订单运费')),
                ('order_status', models.SmallIntegerField(choices=[(1, '待支付'), (2, '待发货'), (3, '待收获'), (4, '待评论'), (5, '已完成')], default=1, verbose_name='订单状态')),
