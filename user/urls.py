...
urlpatterns = [
    ...
    path('',login_required(UserInfoView.as_view()),name='user'),# 用户中心/user/
    path('address/',login_required(AddressView.as_view()),name='address'),# 用户地址信息/user/addrerss
    path('order/',login_required(UserOrderView.as_view()),name='order')# 用户订购信息/user/order
