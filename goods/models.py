...
class GoodsSKU(BaseModel):
    ...
    sales = models.IntegerField(default=1,choices=status_choices,verbose_name='商品销量')
...
class Goods(BaseModel):
    ...
    # 富文本类型：带有格式的文本,相当于mysql中的longtext
...
class IndexTypeGoodBanner(BaseModel):
    ...
    index = models.SmallIntegerField(default=0,verbose_name='展示顺序')
    display_type = models.SmallIntegerField(default=1,choices=DISPLAY_TYPE_CHOICES,verbose_name='展示内容')
    # 外键关联
